    ...
    <div className="w-full flex flex-col justify-center items-center">
      ...
      >
        ...
        <div className="text-white relative -top-20 bg-gradient-to-br from-yellowBackground to-yellowSecondary p-4 w-[280px] rounded-3xl border-white border-2 flex flex-col">
          <div className="w-full text-center text-2xl font-myFont px-10 py-2 bg-lime-900 rounded-full flex justify-center items-center whitespace-nowrap overflow-hidden text-ellipsis">
