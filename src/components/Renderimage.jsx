  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      <div id="capture-area" className="flex flex-col items-center justify-center  z-20   bg-black w-[350px] md:w-[350px]">
        <Image width={2200} height={2200}  src={Group} alt="Mid Image" className="rounded-lg object-cover relative  top-16 -z-20 lg:w-[350px]" />

        <div className="text-white bg-gradient-to-br from-yellowBackground to-yellowSecondary p-2 w-[330px] rounded-3xl border-white border-2 flex flex-col">
