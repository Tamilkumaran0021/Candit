  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      <div id="capture-area" className="flex flex-col items-center justify-center  z-20   bg-black w-[350px] md:w-[350px]">
        ...
        <div className="text-white relative bg-gradient-to-br from-yellowBackground to-yellowSecondary p-2 w-[330px] rounded-3xl border-white border-2 flex flex-col">
